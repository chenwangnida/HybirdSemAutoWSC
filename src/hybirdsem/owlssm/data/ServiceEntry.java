...
public class ServiceEntry implements Comparable{
    ...
    public String toString() {
        if (uri==null)
            return "(" + ID + "/" + MatchmakerUtils.degreeOfMatchIntToString(degreeOfMatch) + "/" + similarity + ")";
        return "("+ uri + "/" + ID + "/" + MatchmakerUtils.degreeOfMatchIntToString(degreeOfMatch) + "/" + similarity + ")";
