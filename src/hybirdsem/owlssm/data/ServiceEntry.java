...
public class ServiceEntry implements Comparable{
    ...
    public String toString() {
        if (uri==null)
            return "(" + ID + "/" + hybirdsem.owlssm.utils.MatchmakerUtils.degreeOfMatchIntToString(degreeOfMatch) + "/" + similarity + ")";
        return "("+ uri + "/" + ID + "/" + hybirdsem.owlssm.utils.MatchmakerUtils.degreeOfMatchIntToString(degreeOfMatch) + "/" + similarity + ")";
