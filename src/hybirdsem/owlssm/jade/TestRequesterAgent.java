...
import hybirdsem.owlssm.data.DegreeOfMatch;
import hybirdsem.owlssm.data.SortingType;
import hybirdsem.owlssm.jade.behaviours.request.RequestAddServicesBehaviour;
import hybirdsem.owlssm.jade.behaviours.request.RequestClearBehaviour;
import hybirdsem.owlssm.jade.behaviours.request.RequestMatchBehaviour;
import hybirdsem.owlssm.jade.behaviours.request.RequestRemoveServicesBehaviour;
import hybirdsem.owlssm.jade.behaviours.request.RequestSendStatusBehaviour;
...
public class TestRequesterAgent extends Agent {
    ...
    public void setup() {
        ...
        getContentManager().registerOntology(hybirdsem.owlssm.jade.ontology.MatchmakerOntology.getInstance());
