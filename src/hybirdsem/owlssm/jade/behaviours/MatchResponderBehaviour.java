 ...
 */
package hybirdsem.owlssm.jade.behaviours;
...
import hybirdsem.owlssm.jade.ontology.MatchAction;
import hybirdsem.owlssm.jade.ontology.MatchedServiceConcept;
import hybirdsem.owlssm.jade.ontology.MatchesPredicate;
import hybirdsem.owlssm.jade.ontology.MatchingResultConcept;
import hybirdsem.owlssm.jade.ontology.ServiceConcept;
...
public class MatchResponderBehaviour extends SimpleAchieveREResponder {
    ...
    protected ACLMessage prepareResultNotification(ACLMessage request, ACLMessage response) {
        ...
        try {
            ...
            hybirdsem.owlssm.data.MatchedService next;
            MatchedServiceConcept matchedService;
            while(setIter.hasNext()) {
                next = (hybirdsem.owlssm.data.MatchedService) setIter.next();
