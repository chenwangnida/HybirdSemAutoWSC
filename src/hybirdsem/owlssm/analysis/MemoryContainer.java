...
package hybirdsem.owlssm.analysis;

import hybirdsem.owlssm.utils.MatchmakerUtils;

public class MemoryContainer extends hybirdsem.owlssm.analysis.DataStorage  {
...
//		baseValue = getCurrentMemory();		
	...
	public void addState(int serviceCount) {
		hybirdsem.owlssm.utils.MatchmakerUtils.wait(3);
