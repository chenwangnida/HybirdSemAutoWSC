...
public class HybirdSemanticService extends SemanticService implements java.io.Serializable {
	...
	public HybirdSemanticService(URI uri) {
		super(uri);
	}
	...
	public HybirdSemanticService(SemanticService item) {
	...
	public HybirdSemanticService(HybirdSemanticService item) {
		this.uri = item.getURI();
		this.fileURI = item.fileURI;
		this.processed = item.processed;
		this.inputs = item.getInputs();
	...
	public int compareTo(Object obj) {
		if (!this.getClass().equals(obj.getClass()))
			return 1;
		HybirdSemanticService item = (HybirdSemanticService) obj;
