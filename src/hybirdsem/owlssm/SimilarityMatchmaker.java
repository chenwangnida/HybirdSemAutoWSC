...
public abstract class SimilarityMatchmaker implements Matchmaker {
    ...
    /**
     * @see hybirdsem.owlssm.Matchmaker#addService(Integer, java.lang.String, java.net.URI)
     */
    abstract public void addService(Integer integer, String profile, java.net.URI baseURI);
    
    /**
     * @see hybirdsem.owlssm.Matchmaker#addService(Integer, java.io.InputStream, java.net.URI)
     */
