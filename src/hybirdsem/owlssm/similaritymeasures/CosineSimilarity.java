...
import hybirdsem.owlssm.utils.CollectionUtils;
import hybirdsem.owlssm.utils.CosineResultTriple;
import hybirdsem.owlssm.utils.MathUtils;
import hybirdsem.owlssm.utils.StringUtils;
    ...
    protected CosineResultTriple getTFArrays(Map pc1, Map pc2) throws MatchingException {
        ...
        while (iter.hasNext()) {
            ...
            if ( (!pc1.containsKey(current)) && (!pc2.containsKey(current)))
            	hybirdsem.owlssm.io.ErrorLog.instanceOf().report("Problem with current: " +  current);
            ...
            if ( (r1[count]==0) && (r2[count]==0))
               hybirdsem.owlssm.io.ErrorLog.instanceOf().report("A new Problem with current: " +  current);
            //if (this.usesIndex())
