...
import hybirdsem.owlsmx.similaritymeasures.ConstraintSimilarity;
import hybirdsem.owlsmx.similaritymeasures.CosineSimilarity;
import hybirdsem.owlsmx.similaritymeasures.ExtendedJaccardMeasure;
import hybirdsem.owlsmx.similaritymeasures.JensenShannonMeasure;
...
public abstract class SimilarityMatchmaker implements Matchmaker {
    ...
    /**
     * @see hybirdsem.owlsmx.Matchmaker#addService(Integer, java.lang.String, java.net.URI)
     */
    abstract public void addService(Integer integer, String profile, java.net.URI baseURI);
    
    /**
     * @see hybirdsem.owlsmx.Matchmaker#addService(Integer, java.io.InputStream, java.net.URI)
     */
    ...
    /**
     * @see hybirdsem.owlsmx.Matchmaker#matchRequest(java.lang.String)
     */
    abstract public SortedSet matchRequest(String profile) throws MatchingException;
    
    /**
     * @see hybirdsem.owlsmx.Matchmaker#matchRequest(java.io.InputStream)
     */
