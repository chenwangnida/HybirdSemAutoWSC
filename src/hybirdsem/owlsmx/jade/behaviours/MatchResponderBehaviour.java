 ...
 */
package hybirdsem.owlsmx.jade.behaviours;

import java.net.URI;
import java.util.SortedSet;
import java.util.Iterator;

import hybirdsem.owlsmx.SimilarityMatchingEngine;
import hybirdsem.owlsmx.jade.ontology.MatchAction;
import hybirdsem.owlsmx.jade.ontology.MatchedServiceConcept;
import hybirdsem.owlsmx.jade.ontology.MatchesPredicate;
import hybirdsem.owlsmx.jade.ontology.MatchingResultConcept;
import hybirdsem.owlsmx.jade.ontology.ServiceConcept;
...
public class MatchResponderBehaviour extends SimpleAchieveREResponder {
    ...
    protected ACLMessage prepareResultNotification(ACLMessage request, ACLMessage response) {
        ...
        try {
            ...
            hybirdsem.owlsmx.data.MatchedService next;
            MatchedServiceConcept matchedService;
            while(setIter.hasNext()) {
                next = (hybirdsem.owlsmx.data.MatchedService) setIter.next();
