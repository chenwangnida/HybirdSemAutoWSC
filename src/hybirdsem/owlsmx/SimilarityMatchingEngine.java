...
//        	        System.out.println("Service ID " + ID + " " + profileURI.toString() );
     ...
     * 24.05.2006
     * 
     * @see hybirdsem.owlsmx.MatchingEngine#addService(java.lang.String, java.net.URI)
     */
...
//    	addService(profileStream, baseURI);
     ...
     * 24.05.2006
     * 
     * @see hybirdsem.owlsmx.MatchingEngine#addService(java.io.InputStream, java.net.URI)
     */
...
//    	matcher.addService(ID, profileStream, baseURI);
    ...
    private boolean shouldPruneService(MatchedService service,int minimumDegreeOfMatch, double treshold){
        if (  (service.degreeOfMatch>minimumDegreeOfMatch) ) {
        	hybirdsem.owlsmx.io.ErrorLog.instanceOf().report("Had to skip (" + service.serviceURI + "/" + service.degreeOfMatch + "/" + service.similarity + ") Degree of service " + service.degreeOfMatch + ">" + minimumDegreeOfMatch );
        	return true;
        }
...
//        	owlsmx.io.ErrorLog.instanceOf().report("Had to skip (" + service.serviceURI + "/" + service.degreeOfMatch + "/" + service.similarity + ") Degree of service " + service.degreeOfMatch + " is not relevant for semantic matching" );
        ...
        if ((service.degreeOfMatch==OWLSMXMatchmaker.NEAREST_NEIGHBOUR) && (service.similarity<treshold)) {
        	hybirdsem.owlsmx.io.ErrorLog.instanceOf().report("Had to skip (" + service.serviceURI + "/" + service.degreeOfMatch + "/" + service.similarity + ") Sim of service " + service.similarity + "<" + treshold );
        	return true;
        }
    ...
    /**
     * @see hybirdsem.owlsmx.MatchingEngine#matchRequest(java.io.InputStream)
     */
    ...
    /**
     * @see hybirdsem.owlsmx.MatchingEngine#matchRequest(java.lang.String)
     */
