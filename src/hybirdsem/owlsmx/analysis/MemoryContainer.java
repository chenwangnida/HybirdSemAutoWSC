...
package hybirdsem.owlsmx.analysis;

import hybirdsem.owlsmx.utils.MatchmakerUtils;

public class MemoryContainer extends hybirdsem.owlsmx.analysis.DataStorage  {
...
//		baseValue = getCurrentMemory();		
	...
	public void addState(int serviceCount) {
		hybirdsem.owlsmx.utils.MatchmakerUtils.wait(3);
