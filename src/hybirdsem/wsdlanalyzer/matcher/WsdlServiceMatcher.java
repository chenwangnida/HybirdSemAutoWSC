package hybirdsem.wsdlanalyzer.matcher;
...
import hybirdsem.wsdlanalyzer.mapping.Mapping;
import hybirdsem.wsdlanalyzer.mapping.MappingPartList;
import hybirdsem.wsdlanalyzer.matrix.ScoreMap;
import hybirdsem.wsdlanalyzer.parser.SimpleTypeLookupTable;
import hybirdsem.wsdlanalyzer.types.Attribute;
import hybirdsem.wsdlanalyzer.types.BindingList;
import hybirdsem.wsdlanalyzer.types.ComplexType;
import hybirdsem.wsdlanalyzer.types.Element;
import hybirdsem.wsdlanalyzer.types.ElementList;
import hybirdsem.wsdlanalyzer.types.Message;
import hybirdsem.wsdlanalyzer.types.MessageList;
import hybirdsem.wsdlanalyzer.types.MessageParameter;
import hybirdsem.wsdlanalyzer.types.NodeIdentifier;
import hybirdsem.wsdlanalyzer.types.Operation;
import hybirdsem.wsdlanalyzer.types.OperationList;
import hybirdsem.wsdlanalyzer.types.PortType;
import hybirdsem.wsdlanalyzer.types.PortTypeList;
import hybirdsem.wsdlanalyzer.types.Sequence;
import hybirdsem.wsdlanalyzer.types.Service;
import hybirdsem.wsdlanalyzer.types.TypeList;
import hybirdsem.wsdlanalyzer.types.WsdlFile;
import hybirdsemwsc.wsdlanalyzer.wordnet.DictInstance;
